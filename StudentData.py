...
dict2=({'Emid':[1000,222,443,100],'Name':["Amy","Matt","Jason","Nikhil"],'Qualification':["Grad","Postgrad","Job","Grad"],'Open':[3,112,113,113],'Result':["Pass","Reattempt","Waiting","Pass"]})
...
df3=pd.merge(df1,df2,how="inner",left_on=["ID","StudentName"], right_on=["Emid","Name"])
print(df3)